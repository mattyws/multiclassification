...
parameters = {
    ...
    "modelCheckpointPath": "../mimic/word2vec_raw_training/checkpoint_tcn_1/",
    ...
    "modelConfigPath": "../mimic/word2vec_raw_training/checkpoint_tcn_1/config.json",
    ...
    "trainingGeneratorPath": "../mimic/word2vec_raw_training/checkpoint_tcn_1/dataTrainGenerator.pkl",
    "testingGeneratorPath": "../mimic/word2vec_raw_training/checkpoint_tcn_1/dataTestGenerator.pkl",
    "resultFilePath": "../mimic/word2vec_raw_training/checkpoint_tcn_1/result.csv",
