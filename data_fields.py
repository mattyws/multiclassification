DATA_FIELDS = {
    ...
    'OUTPUTEVENTS' : ['CHARTTIME', 'VALUE', 'VALUEUOM', 'STORETIME', 'STOPPED', 'NEWBOTTLE', 'ISERROR'],
    'CHARTEVENTS' : ['CHARTTIME', 'STORETIME', 'VALUE', 'VALUENUM', 'VALUEUOM', 'WARNING', 'ERROR', 'RESULTSTATUS',
                     'STOPPED'],
    'PROCEDURES_ICD' : ['SEQ_NUM', 'ICD9_CODE'],
    'MICROBIOLOGYEVENTS' : ['CHARTTIME', 'SPEC_TYPE_DESC', 'ORG_NAME', 'AB_NAME', 'ISOLATE_NUM', 'DILUTION_TEXT',
                            'DILUTION_COMPARISON', 'DILUTION_VALUE', 'INTERPRETATION'],
    'LABEVENTS' : ['ROW_ID', 'CHARTTIME', 'VALUE', 'VALUENUM', 'VALUEUOM', 'FLAG'],
    'DIAGNOSES_ICD' : ['SEQ_NUM', 'ICD9_CODE'],
    'NOTEEVENTS' : ['CHARTDATE', 'CATEGORY', 'DESCRIPTION', 'ISERROR', 'TEXT', 'CHARTTIME'],
    'PRESCRIPTIONS' : ['STARTDATE', 'DRUG_TYPE', 'DRUG', 'DRUG_NAME_POE', 'DRUG_NAME_GENERIC', 'GSN',
