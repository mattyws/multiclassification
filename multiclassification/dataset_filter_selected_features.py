...
dataset_merged_files_path = parameters['mimic_data_path'] + parameters['multiclassification_directory'] \
                                + parameters['merged_events_dirname']
dataset_filtered_files_path = parameters['mimic_data_path'] + parameters['multiclassification_directory'] \
...
with mp.Pool(processes=6) as pool:
    ...
    data_csv.to_csv(parameters['mimic_data_path'] + parameters['multiclassification_directory']
